...
export const addProductThunk = (product) => async (dispatch) => {
    ...
    const response = await fetch("/api/products", {
        ...
        console.error("Error in addProductThunk:", error);
    }
};
...
export const deleteProductThunk = (productId) => async (dispatch) => {
    try {
        ...
        console.error("Error in deleteProductThunk:", error);
    }
};
...
export const getProductsOwnedThunk = (userId) => async (dispatch) => {
    try {
        ...
        if (response.ok) {
            ...
            throw new Error('Failed to fetch user-owned products');
        }
    } catch (error) {
        console.error("Error in getProductsOwnedThunk:", error);
    }
};
...
export const getProductsOneThunk = (productId) => async (dispatch) => {
    try {
        ...
        console.error("Error in getProductsOneThunk:", error);
    }
};
...
export const updateProductThunk = (productForm) => async (dispatch) => {
    try {
        ...
        console.error("Error in updateProductThunk:", error);
    }
};
...
export const insertProductImages = (productId, imageUrl) => async (dispatch) => {
    try {
        ...
        if (response.ok) {
            const newImage = await response.json();
            dispatch({ type: ADD_PRODUCT_IMAGES, payload: newImage });
        } else {
